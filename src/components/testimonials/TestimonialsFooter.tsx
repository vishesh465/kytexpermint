...
const TestimonialsFooter: React.FC = () => (
      ...
      <div className="grid md:grid-cols-4 gap-8 pb-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-400">
            <li><a href="/services" className="hover:text-white transition-colors">Tax Planning</a></li>
            <li><a href="/services" className="hover:text-white transition-colors">Tax Return Filing</a></li>
            <li><a href="/services" className="hover:text-white transition-colors">GST Filing</a></li>
            <li><a href="/services" className="hover:text-white transition-colors">Corporate Taxation</a></li>
          </ul>
        </div>
        <div>
